...
| LIM-007 | Context | Selected-text and window-title capture quality varies by app UI-Automation support | Medium | Fallback to clipboard-copy probe where allowed; mark unsupported apps | v1 | Open | Parity row "Context / Selected text" |
